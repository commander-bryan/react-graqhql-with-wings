...
class SingleReview extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            name: props.review.location.name,
            description: props.review.location.description,
            address: props.review.location.address,
            district: props.review.location.district,
            isEditing: false,
        }
